...
const Profile = () => {
  ...
  return (
    <div className="profile-container">
        ...
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
              ...
              <div className="flex flex-col flex-1 justify-between md:mt-2">
                  ...
                  <div className="flex gap-8 mt-10 items-center justify-center  xl:justify-start  flex-wrap z-20">
                    <StatBlock label="Posts" value={ currentUser?.posts?.length || '0'} />
                    <StatBlock label="Followers" value='20' />
                    <StatBlock label="Following" value='20' />
                  </div>
              ...
              <div className="flex justify-center gap-4">
                  <div className={`${user.id !== currentUser?.$id && 'hidden'}`}>
                      <Link to={`/update-profile/${currentUser?.$id}`} className={`h-12 bg-dark-4 px-4 text-light-1 flex-center gap-2  rounded-lg`}>
                      <img
     ...
     {currentUser?.$id === user.id && (<div className="flex max-w-5xl w-full">
